...
void Chinese1_Show_one(u8 x, u8 y, u8 num, u8 size, u8 mode)
{
    u8 temp,t,t1;
    u8 y0=y;
...
void Chinese2_Show_one(u8 x, u8 y, u8 num, u8 size, u8 mode)
{
    u8 temp,t,t1;
    u8 y0=y;
    u8 csize=(size/8 + ((size%8)?1:0)) * size;     //     16/8+1
...
void Chinese3_Show_one(u8 x, u8 y, u8 num, u8 size, u8 mode)
{
    u8 temp,t,t1;
    u8 y0=y;
    u8 csize=(size/8 + ((size%8)?1:0)) * size;     //     16/8+1
...
void Chinese4_Show_one(u8 x, u8 y, u8 num, u8 size, u8 mode)
{
    u8 temp,t,t1;
    u8 y0=y;
    u8 csize=(size/8 + ((size%8)?1:0)) * size;     //     16/8+1
...
void Chinese5_Show_one(u8 x, u8 y, u8 num, u8 size, u8 mode)
{
    u8 temp,t,t1;
    u8 y0=y;
    u8 csize=(size/8 + ((size%8)?1:0)) * size;     //     16/8+1
...
{
	//初始化汉字显示
	Chinese2_Show_one(90, 125, 0, 16, 0);
	Chinese2_Show_one(135, 125, 1, 16, 0);
	Chinese2_Show_one(185, 125, 2, 16, 0);
	Chinese2_Show_one(98, 150, 3, 16, 0);
	Chinese2_Show_one(114, 150, 4, 16, 0);
	Chinese3_Show_one(56, 208, 0, 16, 0);
	Chinese3_Show_one(86, 208, 1, 16, 0);
	Chinese3_Show_one(56, 238, 2, 16, 0);
	Chinese3_Show_one(86, 238, 3, 16, 0);
	
	//时钟分号显示
	LCD_ShowChar(82, 180, ':', 24, 0);
	LCD_ShowChar(136, 180, ':', 24, 0);
	//温湿度符号显示
	Chinese5_Show_one(146, 210, 7, 16, 0);
	LCD_ShowChar(146, 235, '%', 24, 0);
...
//星期显示控制
void Week_Control(u8 week)
{
	if(week == 1)
	{
		Chinese2_Show_one(130, 150, 5, 16, 0);
	}
	if(week == 2)
	{
		Chinese2_Show_one(130, 150, 6, 16, 0);
	}
	if(week == 3)
	{
		Chinese2_Show_one(130, 150, 7, 16, 0);
	}
	if(week == 4)
	{
		Chinese2_Show_one(130, 150, 8, 16, 0);
	}
	if(week == 5)
	{
		Chinese2_Show_one(130, 150, 9, 16, 0);
	}
	if(week == 6)
	{
		Chinese2_Show_one(130, 150, 10, 16, 0);
	}
	if(week == 7)
	{
		Chinese2_Show_one(130, 150, 11, 16, 0);
	}
...
void Time_Show()
{
	LCD_ShowNum(52, 180, TimeData.hour, 2, 24);
	LCD_ShowNum(106, 180, TimeData.minute, 2, 24);
	LCD_ShowNum(160, 180, TimeData.second, 2, 24);
	LCD_ShowNum(40, 120, TimeData.year, 4, 24);
	LCD_ShowNum(105, 120, TimeData.month, 2, 24);
	LCD_ShowNum(155, 120, TimeData.day, 2, 24);
	LCD_ShowNum(116, 205, Temp, 2, 24);
	LCD_ShowNum(116, 235, Humi, 2, 24);
}
...
void Time_Set_Show()
{
	...
	LCD_ShowNum(105, 120, TimeData.month, 2, 24);
	LCD_ShowNum(155, 120, TimeData.day, 2, 24);
	LCD_ShowNum(130, 150, TimeData.week, 2, 16);
}
